...
(() => {
  // Raw GitHub path for this repo (public)
  ...
  function textColor(bg) {
    ...
    return Y > 0.62 ? "#000" : "#eee"; // black text on lighter cells
  }
  ...
  function groupByMonth(daily) {
    ...
    // use end-of-month close; then month-over-month % change
    const out = [];
  ...
  function groupByWeek(daily) {
    // end-of-week close; then week-over-week % change
